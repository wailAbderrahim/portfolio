...
projects.forEach(project =>{
    ...
    <div class="bg-white shadow-lg rounded-xl overflow-hidden hover:shadow-2xl transition transform hover:-translate-y-2 dark:bg-gray-800">
        <img src="${project.image}" class="h-40 w-full object-cover" alt="project">
        <div class="p-4">
          <h3 class="text-xl font-bold text-slate-900 mb-2 dark:text-slate-100">${project.name}</h3>
          <p class="text-sm text-slate-600 mb-4 dark:text-slate-400">${project.discription}.</p>
