function navigationBar(){
    let nav = `         <header class="sticky top-0 z-50 bg-gray-50 shadow-md transition-all duration-300">
      <nav class="max-w-6xl mx-auto h-14 flex items-center justify-between px-4">
        ...
        <!-- Mobile Menu Button -->
        <button id="menu-btn" class="xl:hidden lg:hidden md:block w-10 h-10 flex items-center justify-center rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-300">
      ...
      <!-- Mobile Dropdown -->
      <div id="navbar-default" class="hidden md:block xl:hidden lg:hidden bg-gray-100 border-t border-gray-200 shadow-sm">
